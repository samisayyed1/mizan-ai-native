//! Mizan AI - LLM orchestration using rig-core.
//!
//! This crate provides the AI assistant functionality for Mizan,
...
//!
//! ```ignore
//! use mizan_ai::{ChatService, ChatConfig, AiEnvironment};
//!
