...
use crate::working_context::ChatWorkingContext;
...
pub(crate) fn attachment_effective_size(attachment: &MessageAttachment) -> usize {
...
async fn spawn_chat_stream<E: AiEnvironment + 'static>(
    ...
    macro_rules! build_with_tools_and_stream {
        ...
        ($client:expr, $thinking_params:expr, $max_tokens:expr) => {{
            ...
            if is_allowed("delete_account") {
                allowed_tools.push(Box::new(tool_set.delete_account));
            }
