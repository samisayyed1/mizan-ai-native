...
pub mod test_env {
    ...
    impl ActivityServiceTrait for MockActivityService {
        ...
        async fn import_activities(
            &self,
            _activities: Vec<ActivityImport>,
        ) -> CoreResult<mizan_core::activities::ImportActivitiesResult> {
        ...
        async fn prepare_activities_for_save(
            ...
            _account: &Account,
        ) -> CoreResult<mizan_core::activities::PrepareActivitiesResult> {
        ...
        async fn upsert_activities_bulk(
            &self,
            _activities: Vec<mizan_core::activities::ActivityUpsert>,
        ) -> CoreResult<mizan_core::activities::BulkUpsertResult> {
    ...
    impl PerformanceServiceTrait for MockPerformanceService {
        ...
        fn calculate_accounts_simple_performance(
            &self,
            _account_ids: &[String],
        ) -> CoreResult<Vec<mizan_core::performance::SimplePerformanceMetrics>> {
            Ok(Vec::new())
        }
    }
    ...
    impl HealthServiceTrait for MockHealthService {
        ...
        async fn run_full_checks(
            &self,
            _base_currency: &str,
            _account_service: Arc<dyn mizan_core::accounts::AccountServiceTrait>,
