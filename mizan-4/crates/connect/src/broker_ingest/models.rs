...
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct LegacyBrokerCheckpoint {
...
impl From<mizan_core::activities::ImportRunType> for ImportRunType {
    fn from(value: mizan_core::activities::ImportRunType) -> Self {
        match value {
            mizan_core::activities::ImportRunType::Sync => Self::Sync,
            mizan_core::activities::ImportRunType::Import => Self::Import,
        }
    }
}

impl From<ImportRunType> for mizan_core::activities::ImportRunType {
...
impl From<mizan_core::activities::ImportRunMode> for ImportRunMode {
    fn from(value: mizan_core::activities::ImportRunMode) -> Self {
        match value {
            mizan_core::activities::ImportRunMode::Initial => Self::Initial,
            mizan_core::activities::ImportRunMode::Incremental => Self::Incremental,
            mizan_core::activities::ImportRunMode::Backfill => Self::Backfill,
            mizan_core::activities::ImportRunMode::Repair => Self::Repair,
        }
    }
}

impl From<ImportRunMode> for mizan_core::activities::ImportRunMode {
...
impl From<mizan_core::activities::ImportRunStatus> for ImportRunStatus {
    fn from(value: mizan_core::activities::ImportRunStatus) -> Self {
        match value {
            mizan_core::activities::ImportRunStatus::Running => Self::Running,
            mizan_core::activities::ImportRunStatus::Applied => Self::Applied,
            mizan_core::activities::ImportRunStatus::NeedsReview => Self::NeedsReview,
            mizan_core::activities::ImportRunStatus::Failed => Self::Failed,
            mizan_core::activities::ImportRunStatus::Cancelled => Self::Cancelled,
        }
    }
}

impl From<ImportRunStatus> for mizan_core::activities::ImportRunStatus {
...
impl From<mizan_core::activities::ReviewMode> for ReviewMode {
    fn from(value: mizan_core::activities::ReviewMode) -> Self {
        match value {
            mizan_core::activities::ReviewMode::Never => Self::Never,
            mizan_core::activities::ReviewMode::Always => Self::Always,
            mizan_core::activities::ReviewMode::IfWarnings => Self::IfWarnings,
        }
    }
}

impl From<ReviewMode> for mizan_core::activities::ReviewMode {
...
impl From<mizan_core::activities::ImportRunSummary> for ImportRunSummary {
    fn from(value: mizan_core::activities::ImportRunSummary) -> Self {
        Self {
...
impl From<ImportRunSummary> for mizan_core::activities::ImportRunSummary {
...
impl From<mizan_core::activities::ImportRun> for ImportRun {
    fn from(value: mizan_core::activities::ImportRun) -> Self {
        Self {
            id: value.id,
...
impl From<ImportRun> for mizan_core::activities::ImportRun {
