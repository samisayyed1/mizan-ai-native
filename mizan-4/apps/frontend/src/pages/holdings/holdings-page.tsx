...
import { EmptyPlaceholder } from "@mizan/ui";
...
export const HoldingsPage = () => {
    ...
    <>
      {hasNoAssets ? (
        <div className="flex items-center justify-center py-16">
          ...
          >
            <Button size="default" onClick={() => openAssistantAssetDraft("asset")}>
              <Icons.Plus className="mr-2 h-4 w-4" />
              Add Asset
            </Button>
          </EmptyPlaceholder>
    ...
    <>
      {hasNoLiabilities ? (
        <div className="flex items-center justify-center py-16">
          ...
          >
            <Button size="default" onClick={() => openAssistantAssetDraft("liability")}>
              <Icons.Plus className="mr-2 h-4 w-4" />
              Add Liability
            </Button>
          </EmptyPlaceholder>
  ...
  const actionPaletteGroups: ActionPaletteGroup[] = useMemo(
        ...
        items: [
          {
            icon: Icons.Wallet,
            label: "Add Asset",
            onClick: () => openAssistantAssetDraft("asset"),
          },
          {
            icon: Icons.Building,
            label: "Add Bank Account",
            onClick: () => openAssistantAssetDraft("bank account"),
          },
          {
            icon: Icons.CreditCard,
            label: "Add Liability",
            onClick: () => openAssistantAssetDraft("liability"),
          },
          {
            icon: Icons.Plus,
            label: "Add Activity",
    ...
    [navigate, openAssistantAssetDraft, updatePortfolioMutation],
  );
