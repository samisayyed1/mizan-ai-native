...
vi.mock("@mizan/ui/components/ui/icons", () => ({
  Icons: {
...
vi.mock("@mizan/ui/components/ui/separator", () => ({
  Separator: () => <span>|</span>,
}));

vi.mock("@mizan/ui/components/ui/skeleton", () => ({
  Skeleton: () => <div>loading</div>,
}));

vi.mock("@mizan/ui/components/ui/tooltip", () => ({
