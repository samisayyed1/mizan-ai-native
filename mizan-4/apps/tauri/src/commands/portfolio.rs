...
/// only delivered a current-snapshot view and
...
pub async fn get_snapshot_by_date(
    ...
    let assets_map: HashMap<String, mizan_core::assets::Asset> = if !asset_ids.is_empty() {
        state
            .asset_service()
    ...
    for position in snapshot.positions.values() {
        ...
        let instrument = mizan_core::holdings::Instrument {
            id: asset.id.clone(),
        ...
        let holding = Holding {
            ...
            fx_rate: None,
            market_value: mizan_core::holdings::MonetaryValue::zero(),
            cost_basis: Some(mizan_core::holdings::MonetaryValue {
    ...
    for (currency, &amount) in &snapshot.cash_balances {
        ...
        let holding = Holding {
            ...
            account_id: account_id.clone(),
            holding_type: mizan_core::holdings::HoldingType::Cash,
            instrument: None,
            ...
            base_currency: base_currency.clone(),
            fx_rate: None,
            market_value: mizan_core::holdings::MonetaryValue {
                local: amount,
                base: Decimal::ZERO,
            },
            cost_basis: Some(mizan_core::holdings::MonetaryValue {
