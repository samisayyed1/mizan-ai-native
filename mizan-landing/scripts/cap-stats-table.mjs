...
// desktop
const d = await b.newContext({ viewport: { width: 1100, height: 1200 }, deviceScaleFactor: 2 });
...
await p1.screenshot({ path: "screenshots/stats-table-desktop.png", fullPage: true });
await d.close();
// mobile
...
await p2.screenshot({ path: "screenshots/stats-table-mobile.png", fullPage: true });
await b.close();
console.log("done");
