...
mod tests {
    ...
    fn test_config() -> Config {
        Config {
            ...
            billing_rate_limit_per_minute: None,
            billing_rate_limit_burst: None,
            plaid_rate_limit_per_minute: None,
            plaid_rate_limit_burst: None,
            oauth_rate_limit_per_minute: None,
            oauth_rate_limit_burst: None,
            mcp_rate_limit_per_minute: None,
            mcp_rate_limit_burst: None,
